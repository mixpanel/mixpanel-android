...
public interface OfflineMode {
  ...
  /**
   * Returns true if offline-mode is active on the client. When true Mixpanel will not start new
   * connections, but current active connections will not be interrupted.
   *
