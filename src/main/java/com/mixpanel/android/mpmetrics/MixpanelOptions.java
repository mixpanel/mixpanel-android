...
public class MixpanelOptions {
  ...
  public static class Builder {
    ...
    /**
     * Sets the distinct instance name for the MixpanelAPI. This is useful if you want to manage
     * multiple Mixpanel project instances.
     *
    ...
    /**
     * Sets the default opt-out tracking state. If true, the SDK will not send any events or profile
     * updates by default. This can be overridden at runtime.
     *
    ...
    /**
     * Sets the super properties to be sent with every event. These properties are persistently
     * stored.
     *
     * @param superProperties A JSONObject containing key-value pairs for super properties. The
     *     provided JSONObject will be defensively copied.
     * @return This Builder instance for chaining.
     */
    ...
    /**
     * Sets the context to be used for evaluating feature flags. This can include properties like
     * distinct_id or other custom properties.
     *
     * @param featureFlagsContext A JSONObject containing key-value pairs for the feature flags
     *     context. The provided JSONObject will be defensively copied.
     * @return This Builder instance for chaining.
     */
