...
/**
 * This class is for internal use in the Mixpanel library, and should not be imported into client
 * code.
 */
public abstract class ResourceReader implements ResourceIds {
  ...
  protected void initialize() {
    ...
    try {
      ...
      MPLog.w(
          LOGTAG,
          "Can't load names for Android view ids from '"
              + localClassName
              + "', ids by name will not be available in the events editor.");
      MPLog.i(
          LOGTAG,
          "You may be missing a Resources class for your package due to your proguard"
              + " configuration, or you may be using an applicationId in your build that isn't the"
              + " same as the package declared in your AndroidManifest.xml file.\n"
              ...
              + " to explicitly point the Mixpanel library to the appropriate library for your"
              + " resources class:\n\n"
