...
public class OptOutTest {
    ...
    @Before
    public void setUp() {
        mMockReferrerPreferences = new TestUtils.EmptyPreferences(ApplicationProvider.getApplicationContext());
        ...
        mAnalyticsMessages = new AnalyticsMessages(ApplicationProvider.getApplicationContext(), MPConfig.getInstance(ApplicationProvider.getApplicationContext(), null)) {
            @Override
    ...
    public void testOptOutDefaultFlag() throws InterruptedException {
        ...
        mMixpanelAPI = new MixpanelAPI(ApplicationProvider.getApplicationContext(), mMockReferrerPreferences, TOKEN, true, null, true) {
            @Override
    ...
    public void testHasOptOutTrackingOrNot() throws InterruptedException {
        ...
        MixpanelAPI mixpanel = new MixpanelAPI(ApplicationProvider.getApplicationContext(), mMockReferrerPreferences, "TOKEN", true, null, true) {
            @Override
            PersistentIdentity getPersistentIdentity(Context context, Future<SharedPreferences> referrerPreferences, String token, String instanceName, DeviceIdProvider deviceIdProvider) {
                mPersistentIdentity = super.getPersistentIdentity(context, referrerPreferences, token, instanceName, deviceIdProvider);
                return mPersistentIdentity;
    ...
    public void testPeopleUpdates() throws InterruptedException, JSONException {
        ...
        mMixpanelAPI = new MixpanelAPI(ApplicationProvider.getApplicationContext(), mMockReferrerPreferences, TOKEN,false, null, true) {
            @Override
            PersistentIdentity getPersistentIdentity(Context context, Future<SharedPreferences> referrerPreferences, String token, String instanceName, DeviceIdProvider deviceIdProvider) {
                mPersistentIdentity = super.getPersistentIdentity(context, referrerPreferences, token, instanceName, deviceIdProvider);
                return mPersistentIdentity;
    ...
    public void testDropEventsAndOptInEvent() throws InterruptedException {
        mMixpanelAPI = new TestUtils.CleanMixpanelAPI(ApplicationProvider.getApplicationContext(), mMockReferrerPreferences, TOKEN) {
            @Override
            PersistentIdentity getPersistentIdentity(Context context, Future<SharedPreferences> referrerPreferences, String token, String instanceName, DeviceIdProvider deviceIdProvider) {
                mPersistentIdentity = super.getPersistentIdentity(context, referrerPreferences, token, instanceName, deviceIdProvider);
                return mPersistentIdentity;
    ...
    private MPDbAdapter getMockDBAdapter() {
        return new MPDbAdapter(ApplicationProvider.getApplicationContext(), MPConfig.getInstance(ApplicationProvider.getApplicationContext(), null)) {
