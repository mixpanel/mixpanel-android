...
public class EditProtocolTest extends AndroidTestCase {
    ...
    public void setUp() throws JSONException {
        ...
        mLayoutEditAlignParentRight = new JSONObject(
            String.format("{\"args\":[{\"verb\":11,\"anchor_id\":-1,\"operation\":\"add\",\"view_id\":%d}],\"path\": [{\"prefix\": \"shortest\", \"index\": 0, \"id\": %d }],\"change_type\": \"layout\", \"name\": \"test1\"}", TestView.RELATIVE_LAYOUT_BUTTON1_ID, TestView.RELATIVE_LAYOUT_ID));
        mLayoutEditBelow = new JSONObject(
                String.format("{\"args\":[{\"verb\":3,\"anchor_id\":%d,\"operation\":\"add\",\"view_id\":%d}],\"path\": [{\"prefix\": \"shortest\", \"index\": 0, \"id\": %d }],\"change_type\": \"layout\", \"name\": \"test2\"}", TestView.RELATIVE_LAYOUT_BUTTON1_ID, TestView.RELATIVE_LAYOUT_BUTTON2_ID, TestView.RELATIVE_LAYOUT_ID));
        mLayoutEditAbove = new JSONObject(
                String.format("{\"args\":[{\"verb\":2,\"anchor_id\":%d,\"operation\":\"add\",\"view_id\":%d}],\"path\": [{\"prefix\": \"shortest\", \"index\": 0, \"id\": %d }],\"change_type\": \"layout\", \"name\": \"test3\"}", TestView.RELATIVE_LAYOUT_BUTTON2_ID, TestView.RELATIVE_LAYOUT_BUTTON1_ID, TestView.RELATIVE_LAYOUT_ID));
