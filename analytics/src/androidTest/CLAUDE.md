...
**IMPORTANT**: Run tests from the analytics module (not `:analytics:mixpaneldemo`). Use `:analytics:connectedAndroidTest` to run tests from the library module.

```bash
# Run all tests (from analytics module)
./gradlew :analytics:connectedAndroidTest

# Run specific test class (from analytics module)
...
# Run specific test method within a class (from analytics module)
...
# Run multiple test methods within a class (comma-separated, from analytics module)
